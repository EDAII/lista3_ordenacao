    ...
    while(1):
        ...
        if ans == 3:
            ...
            for count in range(1, 1000, 10):
                ...
                list_index.append(count)
                tic = timeit.default_timer()
                Sort.count_sort(vector, (max(vector)+1))
                toc = timeit.default_timer()
                time = toc - tic
                list_result.append(time)
            f, axarr = plt.subplots(5, sharex=True)
            axarr[0].plot(list_index, list_result)
            axarr[0].set_title('Count sort unsorted vector')
            ''' Sorted Vector '''
            list_result = []
            list_index = []
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[1].plot(list_index, list_result)
            axarr[1].set_title("Count sort in sorted vector")
            ''' Semi unsorted Vector '''
            list_result = []
            list_index = []
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[2].plot(list_index, list_result)
            axarr[2].set_title("Count sort in semi unsorted vector")
            ...
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[3].plot(list_index, list_result)
            axarr[3].set_title("Count sort in decreasing vector")
            ''' Repeater Vector '''
            list_result = []
            list_index = []
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[4].plot(list_index, list_result)
            axarr[4].set_title("Count sort in repeater vector")
        ...
        if ans == 4:
            ...
            for count in range(1, 1000, 10):
                ...
                list_index.append(count)
                tic = timeit.default_timer()
                Sort.radix_sort(vector)
                toc = timeit.default_timer()
                time = toc - tic
                list_result.append(time)
            f, axarr = plt.subplots(5, sharex=True)
            axarr[0].plot(list_index, list_result)
            axarr[0].set_title('Radix sort unsorted vector')
            ''' Sorted Vector '''
            list_result = []
            list_index = []
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[1].plot(list_index, list_result)
            axarr[1].set_title("Radix sort in sorted vector")
            ''' Semi unsorted Vector '''
            list_result = []
            list_index = []
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[2].plot(list_index, list_result)
            axarr[2].set_title("Radix sort in semi unsorted vector")
            ...
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[3].plot(list_index, list_result)
            axarr[3].set_title("Radix sort in decreasing vector")
            ''' Repeater Vector '''
            list_result = []
            list_index = []
            for count in range(1, 1000, 10):
                ...
                list_result.append(time)
            axarr[4].plot(list_index, list_result)
            axarr[4].set_title("Radix sort in repeater vector")
